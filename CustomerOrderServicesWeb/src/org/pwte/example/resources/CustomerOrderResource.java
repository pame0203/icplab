...
public class CustomerOrderResource {
	...
	public CustomerOrderResource() 
	{
		try {
			...
			//customerOrderServices = (CustomerOrderServices) ctx.lookup("java:global/org.pwte.example.service.CustomerOrderServices");
			customerOrderServices = (CustomerOrderServices) ctx.lookup("jjava:app/CustomerOrderServices/CustomerOrderServicesImpl!org.pwte.example.service.CustomerOrderServices");
